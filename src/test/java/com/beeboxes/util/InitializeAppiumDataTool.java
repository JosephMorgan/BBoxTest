...
/**
 * Description: 人员管理的Appium的初始化
 * @author dengbin
 * @date 2018年6月13日
 */

public class InitializeAppiumDataTool { 	
	String deviceName = "h03v57c2k";//设备名名称	
	String platformVersion = "7.0";//设备的安卓版本号
	
	String appName = new OperateConfig().getProp("人员管理应用");
	String appPackage = new OperateConfig().getProp("人员管理应用的包名");
	String appActivity = new OperateConfig().getProp("人员管理应用的启动页面");
